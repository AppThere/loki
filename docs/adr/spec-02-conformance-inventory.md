...
| | |
|---|---|
| **Status** | Draft — inventory complete; B-1 + B-10 resolved; B-11 unblocked; **build started: M1 skeleton + M2 schema axis + M3 differ core & first round-trip shape landed (B-6/B-7/B-8 in progress)** |
