...
//! Fast reader for the `office:automatic-styles` section of `content.xml`.

use quick_xml::Reader;
use quick_xml::events::Event;

use crate::error::{OdfError, OdfResult};
use crate::odt::model::styles::OdfStyle;
use crate::xml_util::local_attr_val;

use crate::odt::reader::styles::props::{parse_style_family, parse_style_props};
