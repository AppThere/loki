...
# Entry points into the tabbed dialogs (design sections 2–6). Each label ends
# in an ellipsis because the button opens a dialog rather than acting.
...
ribbon-insert-link-dialog-label = Link…
ribbon-insert-link-dialog-aria = Insert link…
ribbon-insert-table-dialog-label = Table…
ribbon-insert-table-dialog-aria = Insert table…
ribbon-properties-dialog-label = Properties…
ribbon-properties-dialog-aria = Document properties…
