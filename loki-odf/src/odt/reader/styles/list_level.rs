...
//! Parsing of `style:list-level-properties` and
//! `style:list-level-label-alignment` child elements.
...
use super::props::parse_text_props_attrs;
...
pub(super) fn parse_label_alignment_child(
    reader: &mut Reader<&[u8]>,
