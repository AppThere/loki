...
//! Paragraph-property parsing for the ODT `styles.xml` reader:
//! `style:paragraph-properties` attributes, its children (drop-cap, tab
//! stops), and the tab-stop list. Split out of `styles.rs` (Phase 7.1);
//! `parse_style_props` calls these. ODF 1.3 §16.5, §20.
...
use crate::odt::model::styles::{OdfDropCap, OdfParaProps, OdfTabStop};
