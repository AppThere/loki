...
| 14 | Typography | **Horizontal text scale not applied.** `CharProps.scale` is mapped from `w:w` (percentage, props.rs:192) but never reaches `StyleSpan` or Parley. | P2 | C | `loki-layout/src/resolve.rs:143–155` | **[OPEN]** |
